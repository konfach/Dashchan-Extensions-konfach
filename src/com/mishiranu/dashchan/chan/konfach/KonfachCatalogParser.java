...
public class KonfachCatalogParser implements GroupParser.Callback
{
	...
	public KonfachCatalogParser(String source, Object linked)
	{
		mSource = source;
		...
		else if ("img".equals(tagName))
		{
			...
			if ("catalogthumb".equals(cssClass))
			{
				...
				if (src != null)
				{
					...
					Matcher matcher = KonfachPostsParser.NUMBER.matcher(src);
					if (matcher.find())
					{
	...
	public void onGroupComplete(GroupParser parser, String text)
	{
		switch (mExpect)
		{
			...
			case EXPECT_OMITTED:
			{
				...
				Matcher matcher = KonfachPostsParser.NUMBER.matcher(text);
